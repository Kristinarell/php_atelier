                ...
                <main class="main authorization_page">
                    ...
                    <div class="authorization_form">
                              <div class="inner_block">
                                ...
                                <form action="authorization.php", method="post" class="form-container" >
                                      <input type="text" name="login" placeholder="Email или телефон:" required class="form">
                                      <input type="password" name="password" placeholder="Пароль:" required class="form">
                                      <a href="registration.php" class="registation">Зарегестрироваться</a>
                                      <input  type="submit" name="sub_auth"class="btn_enter" value="Войти">
